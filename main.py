...
def processImage(filename):
    ...
    # data
    car_data = cv2.CascadeClassifier('vehicle.xml')
    ...
    return None  # Return None if no objects were found in the image
...
def edit():
    ...
    if request.method == "POST": 
        ...
        if file and allowed_file(file.filename):
            ...
            if new:
                processed_image = new  # Set the processed image filename
